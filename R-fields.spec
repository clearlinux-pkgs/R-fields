...
Version  : 9.8.6
Release  : 25
URL      : https://cran.r-project.org/src/contrib/fields_9.8-6.tar.gz
Source0  : https://cran.r-project.org/src/contrib/fields_9.8-6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1566311568
...
R CMD check --no-manual --no-examples --no-codoc fields || :
...
/usr/lib64/R/library/fields/tests/REMLest.test.R
/usr/lib64/R/library/fields/tests/REMLest.test.Rout.save
...
/usr/lib64/R/library/fields/tests/diagonal2.test.R
/usr/lib64/R/library/fields/tests/diagonal2.test.Rout.save
...
/usr/lib64/R/library/fields/tests/mKrig.MLE.test.R
/usr/lib64/R/library/fields/tests/mKrig.MLE.test.Rout.save
